...
- **A theme engine** — Light / Dark / **Hacker** / **Pride**, chosen from a
  ...
  - **Pride:** every menu item / key painted a different rainbow color.
- **A dimmed idle screensaver** (in both apps) — after ~25s untouched the screen
  drops to 40% and plays a themed animation (Matrix rain / "raining men") with
...
- **[WilkinsonRyan](https://github.com/WilkinsonRyan)** — the 4″ ST7796 (`CYD_35`)
  ...
  the Light / Dark / Hacker / Pride theme engine, the Matrix / "raining men"
  screensaver, brightness control, touch recalibration, the JetBrains Mono UI,
